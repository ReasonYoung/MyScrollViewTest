...
-(instancetype)initWithFrame:(CGRect)frame withScrollHeight:(CGFloat)aheight
{
    ...
    if (self)
    {
        ...
        self.scrollView.backgroundColor = [UIColor colorWithRed:45/255.0 green:234/255.0 blue:104/255.0 alpha:0.5];
        
        _scrollView.frame = CGRectMake(0, 0, ScreenWidth, scrollHeight);
        ...
        self.pageControl.frame = (CGRect){0,scrollHeight-20,ScreenWidth,20};
...
{
    [self removTimer];
    // 设置定时器 这里设置的为每3秒钟 执行一次 doWithTimer 方法；
